...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2025 at 12:54 AM
...
INSERT INTO `examinations` (`exam_id`, `subject_id`, `title`, `num_questions`, `passing_score`, `deadline`, `is_active`, `created_at`, `duration`) VALUES
(8, 21, 'qwe', 1, 1, '2025-09-25 05:04:00', 1, '2025-09-10 23:04:37', 1),
(9, 21, 'qwe', 1, 1, '2025-09-19 05:06:00', 1, '2025-09-10 23:06:54', 1);
...
(5, 32, 23, '1231313', '2025-07-30 02:03:08', '2025-07-30 04:01:40'),
(8, 42, 23, '1111111', '2025-07-30 06:00:42', NULL);
...
INSERT INTO `program_sections` (`section_id`, `program_id`, `year_level`, `section_name`) VALUES
(73, 23, 1, 'BSIT-1A'),
(74, 23, 1, 'BSIT-1B'),
(75, 23, 2, 'BSIT-2B'),
(76, 23, 3, 'BSIT-3A'),
...
INSERT INTO `quizzes` (`quiz_id`, `subject_id`, `title`, `num_questions`, `passing_score`, `deadline`, `is_active`, `created_at`, `duration`) VALUES
(8, 21, 'asd', 5, 1, '2025-09-19 12:54:00', 1, '2025-09-10 06:55:43', 1),
(9, 21, 'qwe', 1, 1, '2025-09-25 16:15:00', 1, '2025-09-10 10:15:50', 30);
...
CREATE TABLE `student_exam_attempts` (
  ...
  `status` enum('in_progress','submitted','expired','passed','failed') NOT NULL DEFAULT 'in_progress',
...
INSERT INTO `student_exam_attempts` (`student_exam_attempt_id`, `exam_id`, `student_id`, `start_time`, `end_time`, `score`, `status`, `remarks`, `is_checked`, `submitted_at`, `feedback`) VALUES
(16, 8, 7, '2025-09-11 05:17:01', '2025-09-10 23:18:01', 0, 'expired', 'failed', 0, '2025-09-11 05:18:01', NULL),
(17, 9, 7, '2025-09-11 05:18:12', '2025-09-10 23:19:12', 0, 'expired', 'failed', 0, '2025-09-11 05:19:12', NULL);
...
INSERT INTO `student_quiz_attempts` (`student_quiz_attempt_id`, `quiz_id`, `student_id`, `start_time`, `end_time`, `score`, `status`, `remarks`, `is_checked`, `submitted_at`, `feedback`) VALUES
(31, 8, 7, '2025-09-11 05:14:40', '2025-09-10 23:15:40', 0, 'expired', 'failed', 0, '2025-09-11 05:15:40', NULL);
...
(5, 'admin@example.com', '$2y$10$jBOTs2QufU4yDSOoNw1/vO5QUuUh6P9rO57B14B34/FAdLoSRLWzi', 'Administrator', 'a', 'Administrator', '', 'admin', '2025-06-24 06:55:02', '2025-09-10 01:15:29'),
(32, 'faculty@example.com', '$2y$10$B24y.lrUNHKI.AKSxUkrkOSTuf0irfO6CuihT3q6jE/Al.Y98iPmS', 'Michael', 'Sample', 'Delasa', 'AM', 'faculty', '2025-07-30 02:03:08', '2025-09-10 01:11:48'),
...
(43, 'student@example.com', '$2y$10$UWYXrdU/47tS.oXs2UeZveVhKoLUuqhqpNvTLTW3hRiYvlp/a.CM.', 'studenta', 'students', 'students', 'student', 'student', '2025-08-01 02:48:47', '2025-09-10 01:12:44'),
(44, 'parent@example.com', '$2y$10$1NY/ACAJBe1y72p9Ir3ZGOYzWbP2MITTnfzbrWptXs4GC6KvbMVIi', 'parent', 'parents', 'parentsa', 'p', 'parent', '2025-08-05 04:11:43', '2025-09-10 01:13:10'),
...
--
ALTER TABLE `exam_questions`
  MODIFY `exam_question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `program_sections`
  MODIFY `section_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
ALTER TABLE `quiz_questions`
  MODIFY `quiz_question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `student_exam_answers`
  MODIFY `student_exam_answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `student_exam_attempts`
--
ALTER TABLE `student_exam_attempts`
  MODIFY `student_exam_attempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `student_quiz_answers`
--
ALTER TABLE `student_quiz_answers`
  MODIFY `student_quiz_answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `student_quiz_attempts`
--
ALTER TABLE `student_quiz_attempts`
  MODIFY `student_quiz_attempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
