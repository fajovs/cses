...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2025 at 02:52 PM
...
CREATE TABLE `assignment_submissions` (
  ...
  `equivalent_rate` decimal(3,1) DEFAULT NULL,
...
--
ALTER TABLE `assignment_criteria`
  MODIFY `criteria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `student_quiz_answers`
  MODIFY `student_quiz_answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `student_quiz_attempts`
--
ALTER TABLE `student_quiz_attempts`
  MODIFY `student_quiz_attempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `assignment_submissions`
  ADD CONSTRAINT `assignment_submissions_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`);
...
--
ALTER TABLE `project_submissions`
  ADD CONSTRAINT `project_submissions_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`);
