...
if (!$subject_id || !$assignment_id) {
    ...
    $_SESSION['error'] = 'Missing assignment or subject information.';
...
try {
    ...
    $db->query(
        "INSERT INTO assignment_submissions (
            assignment_id, student_id, file_path, notes, is_checked
        ) VALUES (
            :assignment_id, :student_id, :file_path, :notes, 0
        )",
        [
    ...
    if ($temp_path && $file_path) {
        ...
        if (!move_uploaded_file($temp_path, $uploadPath)) {
            ...
            header('Location: ' . base_url("/student/subject/$subject_id/assignment/$assignment_id"));
            exit;
        }
    }
