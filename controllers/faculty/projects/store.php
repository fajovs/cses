...
if ($file && $file['error'] === UPLOAD_ERR_OK) {
    ...
    if (!in_array($extension, $allowed)) {
        ...
        header('Location: ' . base_url('/faculty/subject/' . $subject_id . '/projects/create'));
        exit;
    }
...
try {
    ...
    $db->query(
        "INSERT INTO projects (subject_id, title, description, deadline, is_active, file_path, file_name)
...
header('Location: ' . base_url('/faculty/subject/' . $subject_id . '/projects'));
exit;
