...
<main class="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100 relative overflow-hidden">
  <!-- Background blur elements -->
  <div class="absolute inset-0 overflow-hidden">
    <div class="absolute -top-40 -right-40 w-80 h-80 bg-indigo-400/20 rounded-full blur-3xl"></div>
    <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-slate-400/20 rounded-full blur-3xl"></div>
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-300/10 rounded-full blur-3xl"></div>
  </div>
  ...
  <div class="relative grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center max-w-lg">
      ...
      <div class="inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-white/70 backdrop-blur-sm border border-white/20 shadow-xl mb-8">
        <p class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-slate-700 bg-clip-text text-transparent">404</p>
      </div>
