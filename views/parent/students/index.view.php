                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-100">
                                ...
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Program</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php foreach ($students as $student): ?>
                                <tr
                                    ...
                                    data-search-value="<?= htmlspecialchars($student['student_name']) ?>">
                                    <td class="px-6 py-5">
                                        <div class="text-sm font-medium text-gray-900"><?= htmlspecialchars($student['student_name']) ?></div>
                                    </td>
                                    <td class="px-6 py-5 text-center">
                                        <span class="text-sm text-gray-600"><?= htmlspecialchars($student['program_name']) ?></span>
                                    </td>
                                     <td class="px-6 py-5 text-center">
                                        <span class="text-sm text-gray-600"><?= htmlspecialchars($student['section_name']) ?></span>
                                    </td>
                                 
                                    <td class="px-6 py-5 text-center">
                             
                                        <a href="<?= base_url("/parent/student/" . htmlspecialchars($student['student_id']) . "/subjects" ) ?>"
