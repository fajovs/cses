                ...
                <div class="max-h-[500px] overflow-y-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php foreach ($notSubmittedProjects as $project): ?>
                                <tr class="hover:bg-gray-25 transition-colors duration-150 searchRow" data-group="active" data-search-value="<?= htmlspecialchars($project['title']) ?>">
                                    <td class="px-6 py-5">
                                    ...
                                    <td class="px-6 py-5 text-center">
                                        <a href="<?= base_url('/student/subject/' . $project['subject_id'] . '/project/' . $project['project_id']) ?>"
                            ...
                            <?php endforeach; ?>
                            <?php if (empty($notSubmittedProjects)): ?>
                                <tr>
                                    <td colspan="5" class="px-6 py-5 text-center text-gray-500">No active projects found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
