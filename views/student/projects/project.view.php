...
<header class="bg-white shadow-sm px-30 flex-none">
    <div class="mx-auto max-w-7xl py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-col gap-4">
            <a href="<?= base_url('/student/subject/' . $subject['subject_id'] . '/projects') ?>"
...
<main class="flex-1 overflow-y-auto px-30 py-6">
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="border border-gray-200 rounded-lg p-6 bg-white shadow-sm">
            <h2 class="text-2xl font-bold text-gray-800 mb-2"><?= htmlspecialchars($project['title']) ?></h2>
            <p class="text-gray-700 mb-2"><?= nl2br(htmlspecialchars($project['description'])) ?></p>
            ...
            <div class="mt-4">
                <?php if (!empty($project['file_path'])): ?>
                    <a href="<?= base_url('/download?file=' . urlencode($project['file_name'])) ?>"
                        ...
                        Download: <?= htmlspecialchars($project['file_name']) ?>
                    </a>
        ...
        <form action="<?= base_url('/student/project/submit') ?>"
            ...
            <input type="hidden" name="subject_id" value=<?= htmlspecialchars($project['subject_id']) ?> />
