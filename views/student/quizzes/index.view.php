                ...
                <div class="max-h-[500px] overflow-y-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php endforeach; ?>
                            <?php if (empty($notAttemptedQuizzes)): ?>
                                <tr>
                                    <td colspan="6" class="px-6 py-5 text-center text-gray-500">No active quizzes found.</td>
                                </tr>
                            <?php endif; ?>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php foreach ($attemptedQuizzes as $quiz): ?>
                                <tr class="hover:bg-gray-25 transition-colors duration-150 searchRow"
                                    ...
                                    <td class="px-6 py-5 text-center"><strong><?= htmlspecialchars($quiz['num_questions']) ?></strong></td>
                                    <td class="px-6 py-5 text-center"><strong><?= htmlspecialchars($quiz['passing_score']) ?></strong></td>

                                    <td class="px-6 py-5 text-center"><?= htmlspecialchars($quiz['deadline']) ?></td>
                                    <td class="px-6 py-5 text-center"><?= htmlspecialchars($quiz['submitted_at']) ?></td>
                                    <td class="px-6 py-5 text-center">
                                        <strong> <?= htmlspecialchars($quiz['score']) ?> / <?= htmlspecialchars($quiz['num_questions']) ?></strong>
                                    </td>
                                    <td class="px-6 py-5 text-center">
                                        <?php
                            ...
                            <?php if (empty($attemptedQuizzes)): ?>
                                <tr>
                                    <td colspan="6" class="px-6 py-5 text-center text-gray-500">No submitted quizzes found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <el-dialog-panel class="group/dialog-panel relative ml-auto block size-full max-w-2xl transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700">
                <div class="flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl">
                    <div class="px-4 sm:px-6">
                        <h2 id="drawer-title" class="text-base font-semibold text-gray-900">Quiz</h2>
                    </div>
