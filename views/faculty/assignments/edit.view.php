...
// Calculate sum of criteria weights for metric scale
...
<main class="flex-1 overflow-y-auto px-30 py-6">
    <h1 class="text-2xl font-bold mb-4"><?= isset($assignment) ? 'Edit Assignment' : 'Create New Assignment' ?></h1>

    <form method="POST" action="<?= base_url('/faculty/subject/' . $subject['subject_id'] . '/assignment/' . $assignment['assignment_id'] . '/update') ?>" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-full">
                        ...
                        <textarea required id="description" name="description" rows="5"
                            ...
                            placeholder="Briefly describe the assignment..."><?= htmlspecialchars($assignment['description']) ?></textarea>
                    </div>
