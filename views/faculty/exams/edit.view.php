            ...
            <div class="border-b border-gray-900/10 pb-12 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="sm:col-span-4">
                    ...
                    <input required type="text" name="title" value="<?= htmlspecialchars($exam['title']) ?>"
                           class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 outline-gray-300 focus:outline-indigo-600 sm:text-sm/6" />
                </div>
                ...
                <?php foreach ($questions as $index => $q): ?>
                    <div class="border-b border-gray-900/10 pb-12 question-block">
                        ...
                        <input required type="text" name="question[]" value="<?= htmlspecialchars($q['question_text']) ?>"
                               class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 outline-gray-300 focus:outline-indigo-600" />
                        ...
                        <div class="sm:col-span-4 mt-4">
                            ...
                            <select name="answer[]" required
                                    class="mt-2 w-full rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 outline-gray-300 focus:outline-indigo-600">
                                <?php foreach (['A','B','C','D'] as $letter): ?>
