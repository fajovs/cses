...
<main class="flex-1 overflow-y-auto px-30 py-6">
    <div class="mb-5">
        <a href="<?= base_url('/faculty/submissions/' . htmlspecialchars($subject['subject_id']) . '/projects') ?>"
    ...
    <div class="border border-gray-200 rounded-lg p-6 bg-white shadow-sm mb-5">
        <h1 class="text-3xl font-bold text-gray-900 mb-2"><?= htmlspecialchars($project['title']); ?> </h1>
        <p class="mt-1 text-sm/6 text-gray-600"><?= htmlspecialchars($project['description']); ?></p>
        ...
        <p class="text-sm text-gray-600">
            <strong>Deadline :</strong> <?= date("F j, Y g:i A", strtotime($project['deadline'])) ?>
        </p>
    ...
    <!-- Active projects -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">Not Evaluluated projects</h2>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php if (empty($unchecked_submissions)): ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-5 text-center text-gray-500">No not evaluated projects found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <!-- Checked projects -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">Evaluated projects</h2>
        <input type="text" placeholder="Search Students..."
            class="searchInput w-full mb-4 px-4 py-3 text-sm bg-white border-0 rounded-lg shadow-sm ring-1 ring-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none transition-all"
            data-target="checked">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php if (empty($checked_submissions)): ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-5 text-center text-gray-500">No evaluated projects found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <el-dialog-panel class="group/dialog-panel relative ml-auto block size-full max-w-2xl transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700">
                <div class="flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl">
                    ...
                    <div class="relative mt-6 flex-1 px-4 sm:px-6">
                        <form method="POST" action=<?= base_url("/faculty/submissions/project/evaluate") ?>>
                            <div class="space-y-12 ">
                                ...
                                <div class="border-b border-gray-900/10 pb-12 flex gap-4 flex-col">
                                    ...
                                    <p id="project-name" class="mt-1 text-sm/6 text-gray-600"></p>
                    ...
                    const criteriaHTML = `
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <div class="w-full">
                                ...
                                <input ${isRequired} type="number" min="0" max="${criteria.weight}"
