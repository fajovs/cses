...
<header class="bg-white shadow-sm px-30 flex-none">
    <div class="mx-auto max-w-7xl py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Submitted Quizzes </h1>
            <p class="mt-1 text-gray-600">View submitted Quizzes. </p>
        </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-100">
                                ...
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Quizzes</th>
                            ...
                            <?php foreach ($subjects as $subject): ?>
                                <tr
                                    ...
                                    <td class="px-6 py-5 text-center">
                                     ...
                                     <td class="px-6 py-5 text-center">
                                        <span class="text-sm text-gray-600"><?= htmlspecialchars($subject['quizzes_count']) ?></span>
                                    </td>
                                    <td class="px-6 py-5 text-center">
