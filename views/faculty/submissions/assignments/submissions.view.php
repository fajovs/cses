...
<main class="flex-1 overflow-y-auto px-30 py-6">
    <div class="mb-5">
        <a href="<?= base_url('/faculty/submissions/' . htmlspecialchars($subject['subject_id']) . '/assignments') ?>"
    ...
    <div class="border border-gray-200 rounded-lg p-6 bg-white shadow-sm mb-5">
        <h1 class="text-3xl font-bold text-gray-900 mb-2"><?= htmlspecialchars($assignment['title']); ?> </h1>
        <p class="mt-1 text-sm/6 text-gray-600"><?= htmlspecialchars($assignment['description']); ?></p>
    ...
    <!-- Active assignments -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">Not Evaluluated assignments</h2>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php if (empty($unchecked_submissions)): ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-5 text-center text-gray-500">No not evaluated assignments found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <!-- Checked assignments -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">Evaluated assignments</h2>
        <input type="text" placeholder="Search Students..."
            class="searchInput w-full mb-4 px-4 py-3 text-sm bg-white border-0 rounded-lg shadow-sm ring-1 ring-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none transition-all"
            data-target="checked">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php if (empty($checked_submissions)): ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-5 text-center text-gray-500">No evaluated assignments found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <el-dialog-panel class="group/dialog-panel relative ml-auto block size-full max-w-2xl transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700">
                <div class="flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl">
                    ...
                    <div class="relative mt-6 flex-1 px-4 sm:px-6">
                        <form method="POST" action=<?= base_url("/faculty/submissions/assignment/evaluate") ?>>
