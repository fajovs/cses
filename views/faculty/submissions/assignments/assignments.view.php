...
<header class="bg-white shadow-sm px-30 flex-none">
    <div class="mx-auto max-w-7xl py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
            <a href="<?= base_url('/faculty/submissions/assignments') ?>"
...
<main class="flex-1 overflow-y-auto px-30 py-6">
    ...
    <!-- Active assignments -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">assignments</h2>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php foreach ($assignments as $assignment): ?>
                                <tr class="hover:bg-gray-25 transition-colors duration-150 searchRow"
                                    ...
                                    <td class="px-6 py-5 text-center"><?= htmlspecialchars($assignment['submitted_count']) ?></td>
                                    ...
                                    <td class="px-6 py-5 text-center flex justify-center gap-2">
                                        ...
                                        <a href="<?= base_url('/faculty/submissions/subject/' . $assignment['subject_id'] . '/assignment/' . $assignment['assignment_id']) ?>"
