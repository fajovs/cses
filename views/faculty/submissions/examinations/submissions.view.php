...
<main class="flex-1 overflow-y-auto px-30 py-6">
    <div class="mb-5">
        <a href="<?= base_url('/faculty/submissions/' . htmlspecialchars($subject['subject_id']) . '/exams') ?>"
    ...
    <div class="border border-gray-200 rounded-lg p-6 bg-white shadow-sm mb-5">
        ...
        <p class="text-sm text-gray-600">
            <strong>Deadline :</strong> <?= date("F j, Y g:i A", strtotime($exam['deadline'])) ?>
        </p>
    </div>

    <!-- Active examinations -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">Not Checked examinations</h2>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php if (empty($unchecked_submissions)): ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-5 text-center text-gray-500">No not checked examinations found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <!-- Checked activities -->
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-2">Checked Examinations</h2>
        <input type="text" placeholder="Search Students..."
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php if (empty($checked_submissions)): ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-5 text-center text-gray-500">No checked examinations found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <el-dialog-panel class="group/dialog-panel relative ml-auto block size-full max-w-2xl transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700">
                <div class="flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl">
                    ...
                    <div class="relative mt-6 flex-1 px-4 sm:px-6">
                        <form method="POST" action=<?= base_url("/faculty/submissions/exam/check") ?>>
                            <div class="space-y-12 ">
                                ...
                                <div class="border-b border-gray-900/10 pb-12 flex gap-4 flex-col">
                                    ...
                                    <p id="exam-name" class="mt-1 text-sm/6 text-gray-600"></p>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('[command="show-modal"][commandfor="drawer"]').forEach(button => {
            button.addEventListener('click', () => {
                ...
                submissionId.value = submission.student_exam_attempt_id;
                ...
                examName.innerHTML = `<strong>Exam Title :</strong><br> ${exam.title}`;
