...
<main class="relative min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-slate-100 px-6 py-24 sm:py-32 lg:px-8 overflow-hidden">
  <!-- Background decorative elements -->
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    <div class="absolute -top-40 -right-32 w-80 h-80 bg-green-400/10 rounded-full blur-3xl"></div>
    <div class="absolute -bottom-40 -left-32 w-80 h-80 bg-slate-400/10 rounded-full blur-3xl"></div>
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-green-300/5 rounded-full blur-3xl"></div>
  </div>
  ...
  <div class="relative grid min-h-full place-items-center">
    <div class="text-center max-w-2xl mx-auto">
      ...
      <div class="flex items-center justify-center gap-x-6">
        <a href="<?= base_url('/') ?>" 
           class="group relative inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white bg-gradient-to-r from-green-600 to-green-700 rounded-xl shadow-lg shadow-green-600/25 hover:shadow-xl hover:shadow-green-600/30 hover:from-green-700 hover:to-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-slate-50 transition-all duration-200 transform hover:-translate-y-0.5">
