<?php
    ...
    if($role === "admin" || ($heading === "Activities" && $role === "student")){
        $addButton =
        <<<HTML
             <button id="openDrawer" class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-lg transition-colors focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 outline-none">
